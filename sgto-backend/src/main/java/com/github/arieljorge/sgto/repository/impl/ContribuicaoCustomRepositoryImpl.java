...
import com.github.arieljorge.sgto.repository.ContribuicaoCustomRepository;
...
public class ContribuicaoCustomRepositoryImpl implements ContribuicaoCustomRepository {
    ...
    public void upsertContribuicoes(List<ContribuicaoUpsertDto> contribuicaoUpsertDtos) {
        final String querySQL = """
            INSERT INTO contribuicao (nome, id_externo, plataforma_origem)
            VALUES (?, ?, ?)
        ...
        jdbcTemplate.batchUpdate(querySQL, contribuicaoUpsertDtos, 50, (ps, item) -> {
